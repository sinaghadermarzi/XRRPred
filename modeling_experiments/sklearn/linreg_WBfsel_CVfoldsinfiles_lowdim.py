...
def filter_and_sort_features (dataset,input_features,target_col,filter_correlation_threshold,mutual_correlation_threshold):
    ...
    #it outputs a list of noncorrelated (corr<mutual_correlation_threshold)
    #these are feautres with highest correlation and they have correlation of greater than filter_correlation_threshold
    scores  = []
